...
public abstract class Proxy {
    ...
    public static Proxy getProxy(ClassLoader cl, Class<?>... ics) {
        ...
        //ProxyCacheMap存放的是<ClassLoader, Map<String, Object>>
        ...
        Proxy proxy = null;
        //cache中存放的是<key,Reference<Proxy>>
        synchronized (cache) {
            do {
                ...
                if (value == PendingGenerationMarker) {
                    ...
                    cache.put(key, PendingGenerationMarker);//放入正在生成标识
                    break;
                }
            }
            while (true);
        ...
        String pkg = null;
        /**
         * 	参考：https://cloud.tencent.com/developer/article/1109459
         *	这里要特别注意一下，生成了两个类，一个类继承了抽象类Proxy，实现了它的抽象方法newInstance。还有一个类proxy01，就是在开始方法栈里看到的代理类。比如：
         * 
